...
namespace odb
{
  ...
  {
    mssql::container_statements_impl< employees_traits > employees_;
  ...
  const char access::object_traits_impl< ::employer, id_mssql >::employees_traits::
  select_statement[] =
  "SELECT "
  "[inverse_employee].[id] "
  ...
  void access::object_traits_impl< ::employer, id_mssql >::employees_traits::
  bind (mssql::bind* b,
        const mssql::bind* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::employer, id_mssql >::employees_traits::
  ...
  const char alias_traits<  ::employee,
    id_mssql,
    access::object_traits_impl< ::position, id_mssql >::employee_tag>::
  table_name[] = "[employee]";

  const query_columns_base< ::position, id_mssql >::employee_type_
  query_columns_base< ::position, id_mssql >::employee;

  struct access::object_traits_impl< ::position, id_mssql >::extra_statement_cache_type
  {
    extra_statement_cache_type (
      mssql::connection&,
      image_type&,
  ...
  access::object_traits_impl< ::position, id_mssql >::id_type
  access::object_traits_impl< ::position, id_mssql >::
  ...
  void access::object_traits_impl< ::position, id_mssql >::
  bind (mssql::bind* b,
        image_type& i,
        mssql::statement_kind sk)
  {
    ...
    if (sk == statement_select)
    {
      ...
      b[n].size_ind = &i.employee_size_ind;
      n++;
    }
  }
        ...
        database* db)
  {
    ...
    //
    {
      ...
      if (i.employee_size_ind == SQL_NULL_DATA)
        v = ptr_traits::pointer_type ();
      else
      {
        obj_traits::id_type id;
        mssql::value_traits<
          ...
          id,
          i.employee_value,
          i.employee_size_ind == SQL_NULL_DATA);
  ...
  const char access::object_traits_impl< ::position, id_mssql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::position, id_mssql >::find_statement[] =
  "SELECT "
  "[inverse_position].[id], "
  ...
  const char access::object_traits_impl< ::position, id_mssql >::update_statement[] =
  "UPDATE [inverse_position] "
  "SET "
  "[title]=? "
  "WHERE [id]=?";

  const char access::object_traits_impl< ::position, id_mssql >::erase_statement[] =
  "DELETE FROM [inverse_position] "
  "WHERE [id]=?";

  const char access::object_traits_impl< ::position, id_mssql >::query_statement[] =
  "SELECT\n"
  "[inverse_position].[id],\n"
  "[inverse_position].[title],\n"
  "[employee].[id]\n"
  ...
  const char access::object_traits_impl< ::position, id_mssql >::erase_query_statement[] =
  "DELETE FROM [inverse_position]";

  const char access::object_traits_impl< ::position, id_mssql >::table_name[] =
  "[inverse_position]";
  ...
  access::object_traits_impl< ::position, id_mssql >::pointer_type
  access::object_traits_impl< ::position, id_mssql >::
  find (database& db, const id_type& id)
  {
    using namespace mssql;
  ...
  bool access::object_traits_impl< ::position, id_mssql >::
  find (database& db, const id_type& id, object_type& obj)
  {
    using namespace mssql;
  ...
  result< access::object_traits_impl< ::position, id_mssql >::object_type >
  access::object_traits_impl< ::position, id_mssql >::
  query (database&, const query_base_type& q)
  {
    using namespace mssql;
  ...
  unsigned long long access::object_traits_impl< ::position, id_mssql >::
  erase_query (database&, const query_base_type& q)
  {
    using namespace mssql;
  ...
  const char access::object_traits_impl< ::project, id_mssql >::employees_traits::
  select_statement[] =
  "SELECT "
  ...
  void access::object_traits_impl< ::project, id_mssql >::employees_traits::
  bind (mssql::bind* b,
        const mssql::bind* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::project, id_mssql >::employees_traits::
  select (index_type&, value_type& v, void* d)
  {
    using namespace mssql;
    using mssql::select_statement;
  ...
  const char alias_traits<  ::position,
    id_mssql,
    access::object_traits_impl< ::employee, id_mssql >::position_tag>::
  table_name[] = "[position]";
        ...
        mssql::statement_kind sk)
  {
    ...
    b[n].size_ind = &i.position_size_ind;
    n++;
  }
        ...
        mssql::statement_kind sk)
  {
    ...
    //
    {
      ...
      if (!is_null)
      {
        ...
        i.position_size_ind = is_null ? SQL_NULL_DATA : 0;
      }
      else
        throw null_pointer ();
    }
        ...
        database* db)
  {
    ...
    //
    {
      ...
      if (i.position_size_ind == SQL_NULL_DATA)
        v = ptr_traits::pointer_type ();
      else
      {
        obj_traits::id_type id;
        mssql::value_traits<
          ...
          id,
          i.position_value,
          i.position_size_ind == SQL_NULL_DATA);
