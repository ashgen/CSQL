...
namespace odb
{
        ...
        mssql::statement_kind sk)
  {
    ...
    b[n].size_ind = &i.middle_size_ind;
    b[n].capacity = static_cast<SQLLEN> (sizeof (i.middle_value));
    n++;
        ...
        database* db)
  {
    ...
    //
    {
      ...
      mssql::value_traits<
        ...
        v,
        i.middle_value,
        static_cast<std::size_t> (i.middle_size_ind),
        i.middle_size_ind == SQL_NULL_DATA);
