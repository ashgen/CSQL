...
namespace odb
{
  ...
  template <typename A>
  const typename query_columns< ::person, id_mssql, A >::email_type_
  ...
  template <typename A>
  const typename query_columns< ::person, id_mssql, A >::middle_type_
  query_columns< ::person, id_mssql, A >::
  middle (A::table_name, "[middle]", 0, 512);
    ...
    public access::object_traits< ::person >
  {
    ...
    struct image_type
    {
      ...
      // middle_
      //
      char middle_value[513];
      SQLLEN middle_size_ind;
