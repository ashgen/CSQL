...
namespace odb
{
  ...
  prepare_query (connection& c, const char* n, const query_base_type& q)
  {
    ...
    mssql::connection& conn (
      static_cast<mssql::connection&> (c));
    ...
    shared_ptr<mssql::prepared_query_impl> r (
      new (shared) mssql::prepared_query_impl (conn));
    r->name = n;
  ...
  execute_query (prepared_query_impl& q)
  {
    ...
    mssql::prepared_query_impl& pq (
      static_cast<mssql::prepared_query_impl&> (q));
    shared_ptr<select_statement> st (
      odb::details::inc_ref (
  ...
  void access::view_traits_impl< ::person_count, id_mssql >::
  bind (mssql::bind* b,
        image_type& i)
  {
    using namespace mssql;
  ...
  access::view_traits_impl< ::person_count, id_mssql >::query_base_type
  access::view_traits_impl< ::person_count, id_mssql >::
  ...
  result< access::view_traits_impl< ::person_count, id_mssql >::view_type >
  access::view_traits_impl< ::person_count, id_mssql >::
  query (database&, const query_base_type& q)
  {
    using namespace mssql;
