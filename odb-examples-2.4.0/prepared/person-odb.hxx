...
namespace odb
{
  ...
  //
  template <>
  class access::view_traits_impl< ::person_count, id_mssql >:
  ...
  class access::view_traits_impl< ::person_count, id_common >:
    public access::view_traits_impl< ::person_count, id_mssql >
  {
  };
  ...
  // person_count
  //
  struct access::view_traits_impl< ::person_count, id_mssql >::query_columns:
