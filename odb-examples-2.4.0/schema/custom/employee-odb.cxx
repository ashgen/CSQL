...
namespace odb
{
  ...
  {
    mssql::container_statements_impl< degrees_traits > degrees_;
  ...
  const char access::object_traits_impl< ::employee, id_mssql >::degrees_traits::
  select_statement[] =
  "SELECT "
  ...
  void access::object_traits_impl< ::employee, id_mssql >::degrees_traits::
  bind (mssql::bind* b,
        const mssql::bind* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::employee, id_mssql >::degrees_traits::
        ...
        mssql::statement_kind sk)
  {
    ...
    // name_
    //
    composite_value_traits< ::employee::name_type, id_mssql >::bind (
      b + n, i.name_value, sk);
    n += 2UL;
        ...
        mssql::statement_kind sk)
  {
    ...
    //
    {
      ...
      composite_value_traits< ::employee::name_type, id_mssql >::init (
        i.name_value,
        v,
        sk);
    }
