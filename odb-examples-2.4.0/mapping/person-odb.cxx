...
namespace odb
{
        ...
        mssql::statement_kind sk)
  {
    ...
    b[n].buffer = &i.born_value;
    b[n].size_ind = &i.born_size_ind;
    n++;

    // married_
    //
    b[n].type = mssql::bind::string;
    b[n].buffer = &i.married_value;
    b[n].size_ind = &i.married_size_ind;
    b[n].capacity = static_cast<SQLLEN> (sizeof (i.married_value));
    n++;
  }
        ...
        mssql::statement_kind sk)
  {
    ...
    //
    {
      ...
      mssql::value_traits<
        ...
        i.born_value, is_null, v);
      i.born_size_ind = is_null ? SQL_NULL_DATA : 0;
    }
        ...
        database* db)
  {
    ...
    //
    {
      ...
      mssql::value_traits<
        ...
        v,
        i.married_value,
        static_cast<std::size_t> (i.married_size_ind),
        i.married_size_ind == SQL_NULL_DATA);
    }
  }
