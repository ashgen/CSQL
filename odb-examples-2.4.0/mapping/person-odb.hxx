...
namespace odb
{
  ...
  template <typename A>
  const typename query_columns< ::person, id_mssql, A >::born_type_
  query_columns< ::person, id_mssql, A >::
  born (A::table_name, "[born]", 0);

  template <typename A>
  const typename query_columns< ::person, id_mssql, A >::married_type_
  query_columns< ::person, id_mssql, A >::
  married (A::table_name, "[married]", 0, 5);
    ...
    public access::object_traits< ::person >
  {
    ...
    struct image_type
    {
      ...
      // born_
      //
      mssql::date born_value;
      SQLLEN born_size_ind;

      // married_
      //
      char married_value[6];
      SQLLEN married_size_ind;
